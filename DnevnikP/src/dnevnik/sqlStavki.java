...
public class sqlStavki {
	...
	public sqlStavki(){
		...
		sql_stavki.put("Seznam_Priprav","select pu.Naslov_Ure, pu.Datum from dnevnik.podatki_ure pu, dnevnik.ucna_priprava p WHERE pu.id = p.podatki_ure_id AND UPORABNIK_ID = ?;");
